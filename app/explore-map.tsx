    ...
    <View style={{ flex: 1, backgroundColor: "#F8FAFC" }}>
      ...
      {MapView && Marker ? (
        ...
        <View style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0 }}>
          ...
          <View style={{ position: "absolute", left: 0, right: 0, top: 0, bottom: 0, backgroundColor: "rgba(15,23,42,0.18)" }} />
          <View style={{ position: "absolute", left: 18, right: 18, bottom: 110, borderRadius: 14, backgroundColor: "rgba(255,255,255,0.95)", paddingHorizontal: 12, paddingVertical: 10 }}>
            <Text style={{ fontSize: 12, fontWeight: "700", color: colors.navy }}>
              Map module missing locally. Run: npx expo install react-native-maps
            </Text>
          </View>
        </View>
      )}
