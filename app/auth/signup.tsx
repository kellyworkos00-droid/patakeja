        ...
        <View style={{ marginTop: 26, gap: 14 }}>
          ...
          >
            ...
            <View style={{ flex: 1, paddingHorizontal: 14 }}>
              <Text style={{ fontSize: 15, fontWeight: "800", color: "#1F2937", letterSpacing: 0.1 }}>Sign up with Google</Text>
              <Text style={{ fontSize: 12, color: "#94A3B8", fontWeight: "500", marginTop: 2 }}>Fast & secure sign‑up</Text>
            </View>
          ...
          >
            ...
            <View style={{ flex: 1, paddingHorizontal: 14 }}>
              ...
              <Text style={{ fontSize: 12, color: "rgba(255,255,255,0.45)", fontWeight: "500", marginTop: 2 }}>Sign up with your TikTok account</Text>
            </View>
