    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#F8FAFC" }} edges={["top", "left", "right", "bottom"]}>
      ...
      >
        ...
        <View style={{ marginTop: 28, gap: 12 }}>
          ...
          {/* Google */}
          <Pressable onPress={handleGoogleSignup} disabled={loading}
          ...
          >
            <View style={{
              ...
              <View style={{
                ...
                <ExpoImage source={images.googleIcon} style={{ width: 24, height: 24 }} contentFit="contain" />
              </View>
              <View style={{ flex: 1, paddingLeft: 14 }}>
                <Text style={{ fontSize: 15, fontWeight: "800", color: "#111827", letterSpacing: 0.1 }}>Sign up with Google</Text>
                <Text style={{ fontSize: 12, color: "#94A3B8", fontWeight: "500", marginTop: 2 }}>Safe, fast & secure sign‑up</Text>
              </View>
              <View style={{ flexDirection: "row", gap: 3 }}>
                <View style={{ width: 6, height: 6, borderRadius: 3, backgroundColor: "#4285F4" }} />
